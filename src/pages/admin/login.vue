    ...
    <div class="grid grid-cols-2 h-screen">
        ...
        <div class="col-span-2 order-2 p-10 md:col-span-1 md:order-1 animate__animated animate__bounceInLeft animate__fast"
            ...
            <div class="flex justify-center items-center h-full flex-col">
                <h2 class=" text-4xl mb-7  text-black leftTextTitle">Weblog 博客登录</h2>
                <p class=" text-black leftTextDescription">一款由 Spring Boot + Mybaits Plus + Vue 3.2 + Vite 4 开发的前后端分离博客。
                </p>
                <!-- 指定图片宽度为父级元素的 1/2 -->
                <img src="@/assets/image/LoginBackground.png" class="w-1/2">
            </div>
        </div>
        <div
            class="flex flex-col col-span-2 order-1 md:col-span-1 md:order-2 bg-white animate__animated animate__bounceInRight animate__fast">
            ...
            <div class="flex justify-center items-center h-full flex-col">
                ...
                <!-- 大标题，设置字体粗细、大小、下边距 -->
                <h1 class="text-4xl mb-5" style="font-family: 'hanyixiangsuruqin';">欢迎回来</h1>
                ...
                <el-form class="w-5/6 md:w-2/5" ref="formRef" :rules="rules" :model="form">
                    ...
                    <el-form-item label="是否记住密码：">
                        <el-switch v-model="remember" inline-prompt active-text="是" inactive-text="否" />
                    </el-form-item>
                    <el-form-item>
                        <!-- 登录按钮，宽度设置为 100% -->
...
const form = reactive({
    ...
    password: localStorage.getItem("password") ? decryptAES(localStorage.getItem("password"), encryptionKey) : "",
})
        ...
        login(form.username, form.password).then((res) => {
            ...
            if (res.success == true) {
                ...
                if (remember.value) {
                    ...
                    localStorage.setItem("password", encryptAES(form.password, encryptionKey));
                } else {
