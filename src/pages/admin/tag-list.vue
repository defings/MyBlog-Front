<template>
    <div>
        ...
        <el-card shadow="never" class="mb-5" style="background: rgb(255, 255, 255, 0.8);">
            <!-- flex 布局，内容垂直居中 -->
        ...
        <el-card shadow="never" style="background: rgb(255, 255, 255, 0.8);">
            <!-- 新增按钮 -->
            <div class="mb-5">
            ...
            <el-table :data="tableData" border stripe style="width: 100%" v-loading="tableLoading">
                <el-table-column prop="name" label="标签名称" width="180" align="center">
