<template>
    <div>
        ...
        <el-card style="background: rgb(255, 255, 255, 0.8);" class="mb-5">
            <!-- flex 布局，内容垂直居中 -->
            ...
            <el-table :data="tableData" border stripe style="width: 100%" v-loading="tableLoading">
                ...
                <el-table-column prop="cover" label="封面" width="180" align="center">
                    <template #default="scope">
                        <el-image style="width: 75px;" :src="scope.row.cover" />
                    </template>
                </el-table-column>
                <el-table-column prop="readNum" label="阅读数" width="100" align="center"/>
        ...
        <el-dialog v-model="isArticlePublishEditorShow" :fullscreen="true" :show-close="false">
            <template #header="{ close, titleId, titleClass }">
                <div class="flex h-10 bg-white mt-3">
                    <!-- 字体加粗 -->
