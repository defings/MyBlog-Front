<template>
    ...
    <main class="container max-w-screen-xl mx-auto p-4 px-6">
        ...
        <div class="grid grid-cols-1 mt-24 md:ml-24">
            <!-- 左边栏，占用 3 列 -->
            <div class="col-span-4 md:col-span-4 mb-3">
                <!-- 分类列表 -->
                <div
                    ...
                    <ol v-if="articles && articles.length > 0"
                        ...
                        <li v-for="(article, index) in articles" :key="index">
                            <a @click="goArticleDetailPage(article.id)" class="items-center block p-3 sm:flex hover:bg-gray-100 dark:hover:bg-gray-700 cursor-pointer">
                                <img class="w-36 h-24 mb-3 mr-3 rounded-lg sm:mb-0" :src="article.cover" />
...
import { getCategoryArticlePageList, getCategoryList } from '@/api/front/category'
