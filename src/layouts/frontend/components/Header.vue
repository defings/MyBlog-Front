<template>
    <header class="sticky top-0 z-50" style="background: rgb(255, 255, 255, 0.5);">
        <nav class=" dark:bg-gray-900 z-50 fixed w-full"
            style="background: rgb(255, 255, 255, 0.5); backdrop-filter: blur(5px);-webkit-backdrop-filter:blur(5px);">
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                <!-- 博客 LOGO 、博客名称 -->
                <a href="/" class="flex items-center">
                    <img :src="blogSettingsStore.blogSettings.logo" class="h-8 mr-3 rounded-full" alt="博客logo" />
                ...
                <div class="flex items-center md:order-2">
                    ...
                    <div class="relative hidden mr-2 md:block">
                        <button type="button" @click="clickSearchBtn"
                            class="mr-2 hidden outline-none md:flex items-center text-sm leading-6 text-slate-800 rounded-md ring-1 ring-slate-900/30 shadow-sm py-1.5 pl-2 pr-3 hover:ring-slate-300 dark:bg-slate-800 dark:highlight-white/5 dark:hover:bg-slate-700">
                            <svg class="w-3.5 h-3.5 mr-2 text-gray-800 dark:text-gray-400" aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-width="2" d="m19 19-4-4m0-7A7 7 0 1 1 1 8a7 7 0 0 1 14 0Z" />
                            </svg>
                            <span class="mr-3">搜索文章 ...</span>
                            <span class="px-2 py-[1px] flex-none text-xs border text-gray-800 rounded">Ctrl K</span>
                        </button>
                    </div>

                    <!-- 登录 -->
                    <div class="text-gray-900 ml-1 mr-1 hover:text-pink-500 cursor-pointer" v-if="!isLogined"
                        @click="$router.push('/login')">登录</div>
                    <!-- 已经登录，展示用户头像 -->
                    <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown" v-else
                        class="text-white ml-2 focus:ring-4 focus:ring-blue-100 font-medium rounded-full text-sm text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                        type="button">
                        <!-- 用户登录头像 -->
                    ...
                    <button data-collapse-toggle="navbar-search" type="button"
                        class="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200/100 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
                ...
                <div class="items-center justify-between w-full md:flex md:w-auto md:order-1" id="navbar-search">
                    <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700"
                        style="background: rgb(255, 255, 255, 0); font-size: 23px; font-family: 'hanyifengbomili';">
                        <li>
                            <a @click="router.push('/')" :class="[currPath == '/' ? 'text-pink-600' : 'text-gray-900']"
                                class="block py-2 pl-3 pr-4  rounded md:bg-transparent md:p-0 md:dark:text-blue-500 cursor-pointer"
                                aria-current="page">首页</a>
                        </li>
                        <li>
                            <a @click="router.push('/category/list')"
                                :class="[currPath == '/category/list' ? 'text-pink-600' : 'text-gray-900']"
                                class="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-pink-100 md:hover:bg-transparent md:hover:text-pink-500 md:p-0 md:dark:hover:text-pink-300 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700 cursor-pointer">分类</a>
                        </li>
                        <li>
                            <a @click="router.push('/tag/list')"
                                :class="[currPath == '/tag/list' ? 'text-pink-600' : 'text-gray-900']"
                                class="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-pink-100 md:hover:bg-transparent md:hover:text-pink-500 md:p-0 dark:text-white md:dark:hover:text-pink-300 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700 cursor-pointer">标签</a>
                        </li>
                        <li>
                            <a @click="router.push('/archive/list')"
                                :class="[currPath == '/archive/list' ? 'text-pink-600' : 'text-gray-900']"
                                class="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-pink-100 md:hover:bg-transparent md:hover:text-pink-500 md:p-0 dark:text-white md:dark:hover:text-pink-300 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700 cursor-pointer">归档</a>
                        </li>
                        <li>
                            <a href="#"
                                class="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-pink-100 md:hover:bg-transparent md:hover:text-pink-500 md:p-0 dark:text-white md:dark:hover:text-pink-300 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">友链</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="relative p-4 w-full max-w-2xl max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                    <form class="w-full mr-2">
                        ...
                        <div class="relative">
                            ...
                            <div v-else class="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
                ...
                <div v-if="searchArticles && searchArticles.length > 0">
                    <p class="text-base leading-relaxed text-gray-500 dark:text-gray-400 ml-3">
                        共搜索到 {{ total }} 篇相关文章
                    </p>
...
import { getArticleSearchPageList } from '@/api/front/search'
// 初始化 flowbit 相关组件
